...
aws elasticbeanstalk create-application-version --region=eu-west-1 --application-name "EFR Application" \
  --version-label $SHA1 --source-bundle S3Bucket="elasticbeanstalk-eu-west-1-696293867939",S3Key="efr-service-go.zip"


# Update Elastic Beanstalk environment to new version
aws elasticbeanstalk update-environment --region=eu-west-1 --environment-name efr-prod \
    --version-label $SHA1
